...
class GameState:
    ...
    def reset(self):
        ...
        state_msg_0.pose.position.x = -4  #-5.2
...
if __name__ == '__main__':
    try:
        ...
        game_state.game_step(game_state.robot_name[0],time_step=1,linear_x=1,angular_z=0)
        #print(game_state.position[game_state.robot_name[0]])
