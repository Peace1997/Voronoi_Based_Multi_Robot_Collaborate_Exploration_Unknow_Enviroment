...
class GameState:
    ...
    def reset(self):
        ...
        state_msg.pose.orientation.z = 0.11
    ...
    def game_step(self, time_step=0.1, linear_x=0.8, angular_z=0.3):
        ...
        record_time_step = 0
        self.move_cmd.linear.x = linear_x*0.15 # 0.25
        self.move_cmd.angular.z = angular_z*0.60  # 1 
        self.rate.sleep()
        ...
        state = np.append(state, linear_x*0.15) # 0.26
        state = np.append(state, angular_z*0.6) # 1
