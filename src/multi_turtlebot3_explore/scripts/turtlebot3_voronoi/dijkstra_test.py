...
class GameState:
    ...
    def reset(self):
        ...
        state_msg_0.pose.position.x = 4.0
        state_msg_0.pose.position.y = -4.6 #random_turtlebot_y
        ...
        state_msg_1.pose.position.x = 1.5
        state_msg_1.pose.position.y = -4.6  #random_turtlebot_y
        ...
        state_msg_2.pose.position.x = -1.0
        state_msg_2.pose.position.y = -4.6  #random_turtlebot_y
    ...
    def game_step(self, robot_name):
        ...
        while move_base.wait_for_server(rospy.Duration(5.0)) == 1:
