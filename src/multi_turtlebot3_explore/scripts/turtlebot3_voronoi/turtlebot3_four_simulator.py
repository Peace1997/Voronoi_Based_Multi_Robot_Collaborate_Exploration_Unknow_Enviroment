...
class GameState:
    ...
    def __init__(self):
        ...
        self.robot_name = ['tb3_0','tb3_1','tb3_2','tb3_3']
        self.position = {'tb3_0':Point(),'tb3_1':Point(),'tb3_2':Point(),'tb3_3':Point()}

        self.rotation = {'tb3_0':0.0,'tb3_1':0.0,'tb3_2':0.0,'tb3_3':0.0}
        
        # record target position
        self.record_info_node = {'tb3_0':[],'tb3_1':[],'tb3_2':[],'tb3_3':[]}

        # set netx target position
        self.next_target_node = {'tb3_0':[],'tb3_1':[],'tb3_2':[],'tb3_3':[]}

        # whether arrive information node 
        self.arr_info_node = {'tb3_0':False,'tb3_1':False,'tb3_2':False,'tb3_3':False}
        ...
        # 
        self.laser_crashed_value = {'tb3_0':False,'tb3_1':False,'tb3_2':False,'tb3_3':False}
        ...
        cmd_vel_3 = rospy.Publisher('tb3_3/cmd_vel', Twist, queue_size=10)
        self.cmd_vel_pub = {'tb3_0':cmd_vel_0,'tb3_1':cmd_vel_1,'tb3_2':cmd_vel_2,'tb3_3':cmd_vel_3}
    ...
    def reset(self):
        ...
        state_msg_2.pose.position.y = 1.0 #random_turtlebot_y
        ...
        state_msg_3 = ModelState()    
        state_msg_3.model_name = 'tb3_3'
        state_msg_3.pose.position.x = -3
        state_msg_3.pose.position.y = 2.0#random_turtlebot_y
        state_msg_3.pose.position.z = 0
        state_msg_3.pose.orientation.x = 0
        state_msg_3.pose.orientation.y = 0
        state_msg_3.pose.orientation.z = 0
        state_msg_3.pose.orientation.w = 0
        state_msg_3.twist.linear.x= 0.0
        state_msg_3.twist.linear.y= 0.0
        state_msg_3.twist.linear.z= 0.0
        state_msg_3.twist.angular.x = 0.0
        state_msg_3.twist.angular.y = 0.0
        state_msg_3.twist.angular.z = 0.0
       ...
       # get position of robot
        ...
        self.rate.sleep()
        initial_state = [initial_state]*len(self.robot_name)
